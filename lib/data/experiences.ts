...
export const allExperiences: Experience[] = [
	{
		id: 401,
		role: "Co-Lead",
		company: "Google Developer Group (FUOYE)",
		date: "Jul 2026 - Present",
		dateVal: 202608,
		description:
			"Co-leading the Google Developer Group on campus, organizing technical workshops, developer meetups, and hackathons to empower student developers with modern technology.",
		mode: "general",
	},
	{
		id: 4,
